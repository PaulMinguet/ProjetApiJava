...
public class PassageP implements Passage {
    ...
    public void setEtatPassage(EtatPassage e){
        ...
        System.out.println("Passage : "+this.toString()+" "+e);
        ...
        try{
            ...
            PreparedStatement pst = cnx.prepareStatement("UPDATE API_Passage SET passageEtat = (?) WHERE passageNom = (?)");
            pst.setString(1, e.toString());
            pst.setString(2, this.toString());
            pst.executeUpdate();
            pst.close();
            cnx.close();
        }
